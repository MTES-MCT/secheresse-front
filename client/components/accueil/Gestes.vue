    ...
    <div class="fr-grid-row fr-grid-row--center fr-grid-row--middle">
      <div class="fr-col-12 fr-col-md-6">
        <DsfrPicture src="/repartition_consommation.svg"
                     size="small"
                     alt="Répartition de la consommation d'eau potable des français selon les usages. 39% - Se laver, 20% - Aller au WC, 12% - Laver son linge, 10% - Faire la vaisselle, 6% - Cuisiner, 6% - Laver sa voiture, 1% - Boire, 6% - Divers"
