...
<template>
  ...
  <div class="fr-mt-8w">
    ...
    <p>Cette déclaration d’accessibilité s’applique à <strong>Sécheresse</strong><span> (<span>secheresse.gouv.fr</span>)</span>.</p>
    <h2>État de conformité</h2>
    <p>
      <strong>Sécheresse</strong> est
    ...
    <p>
      ...
      href="https://betagouv.github.io/a11y-generateur-declaration/#create">Générateur de Déclaration d’Accessibilité de BetaGouv</a>.
    </p>
  </div>
</template>